      ...
      <div className='bg-white w-full p-4 max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[95vh]'>
        <section className=''>
          <div className='p-2   bg-white shadow-md flex items-center justify-between'>
            <h2 className='font-semibold'>Editer produit</h2>
          ...
          <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
              <div className='grid gap-1'>
                <label htmlFor='name' className='font-medium'>Désignation</label>
                <input
                  id='name'
                  type='text'
              ...
              <div className='grid gap-1'>
                ...
                <div>
                  ...
                  >
                    <option value={""}>Choisie Categories</option>
                    {
              ...
              <div className='grid gap-1'>
                <label className='font-medium'>Sous Catégories</label>
                <div>
                  <select
                    className='bg-blue-50 border w-full p-2 rounded'
                  ...
                  >
                    <option value={""} className='text-neutral-600'>Choisie un sous Categorie</option>
                    {
              ...
              <div className='grid gap-1'>
                <label htmlFor='unit' className='font-medium'>Unité</label>
                <input
                  id='unit'
                  type='text'
                  name='unit'
              ...
              <div className='grid gap-1'>
                <label htmlFor='stock' className='font-medium'>Kilo disponible en stock</label>
                <input
                  id='stock'
                  type='number'
                  name='stock'
              ...
              <div className='grid gap-1'>
                <label htmlFor='discount' className='font-medium'>Réduction</label>
                <input
                  id='discount'
                  type='number'
